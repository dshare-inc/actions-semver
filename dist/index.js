...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const extracted = util_1.version(version);
            core.debug(`🔍 Version=${extracted.version}, Prefix=${extracted.prefix}, Suffix=${extracted.suffix}`);
            core.setOutput('original_version', util_1.result(extracted, options));
            core.setOutput('prefix', (_a = extracted.prefix) !== null && _a !== void 0 ? _a : '');
            core.setOutput('suffix', (_b = extracted.suffix) !== null && _b !== void 0 ? _b : '');
            if (method === 'default') {
                core.setOutput('version', util_1.result(extracted, options));
                return;
            }
